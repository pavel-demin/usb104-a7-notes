...
cell port_slicer slice_1 {
  DIN_WIDTH 352 DIN_FROM 79 DIN_TO 64
} {
  din hub_0/cfg_data
}
...
cell port_slicer slice_2 {
  DIN_WIDTH 352 DIN_FROM 95 DIN_TO 80
} {
  din hub_0/cfg_data
}
...
for {set i 0} {$i <= 7} {incr i} {
  ...
  # Create port_slicer
  cell port_slicer slice_[expr $i + 3] {
    DIN_WIDTH 352 DIN_FROM [expr $i + 32] DIN_TO [expr $i + 32]
  } {
    din hub_0/cfg_data
  }
  ...
  cell port_selector selector_$i {
    ...
    cfg slice_[expr $i + 3]/dout
    din /adc_0/m_axis_tdata
  }

  # Create port_slicer
  cell port_slicer slice_[expr $i + 11] {
    DIN_WIDTH 352 DIN_FROM [expr 32 * $i + 127] DIN_TO [expr 32 * $i + 96]
  } {
    din hub_0/cfg_data
  }

  # Create axis_constant
  cell axis_constant phase_$i {
    AXIS_TDATA_WIDTH 32
  } {
    cfg_data slice_[expr $i + 11]/dout
    aclk /pll_0/clk_out1
  }
